...
// mapped from textual names used in the tests below to actual Confero private
...
// address retrieves the Confero address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Confero address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/confero-network/go-confero/issues/17593). Whilst this
