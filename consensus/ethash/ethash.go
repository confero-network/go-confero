...
// all blocks' seal as valid, though they still have to conform to the Confero
// consensus rules.
...
// still have to conform to the Confero consensus rules.
...
// they still have to conform to the Confero consensus rules.
