...
import (
	...
	"github.com/confero-network/go-confero/accounts/abi/bind/backends"
	...
	"github.com/confero-network/go-confero/contracts/checkpointoracle/contract"
	...
	"github.com/confero-network/go-confero/les/checkpointoracle"
	"github.com/confero-network/go-confero/les/flowcontrol"
	vfs "github.com/confero-network/go-confero/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some cofe to user1
		...
		case 1:
			...
			// bankUser transfers more cofe to user1
		...
		case 2:
			...
			// bankUser transfer some cofe to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
