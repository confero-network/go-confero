...
import (
	...
	"github.com/confero-network/go-confero/common/bitutil"
	"github.com/confero-network/go-confero/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Confero
...
func (eth *LightConfero) startBloomHandlers(sectionSize uint64) {
