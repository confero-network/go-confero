...
# 1. install gcofe for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gcofe
# 5. create gcofe, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable CONFERO_SOCKET
...
!define GROUPNAME "Confero"
!define APPNAME "Gcofe"
!define DESCRIPTION "Official Go implementation of the Confero protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gcofe is installed global
