Name "gcofe ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/confero-network/go-confero/issues"
!define UPDATEURL "https://github.com/confero-network/go-confero/releases"
!define ABOUTURL "https://github.com/confero-network/go-confero#confero-go"
...
# Install gcofe binary
Section "Gcofe" GCOFE_IDX
  SetOutPath $INSTDIR
  file {{.Gcofe}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gcofe.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gcofe.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gcofe incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gcofe outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gcofe UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gcofe incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gcofe.exe" "" "" "Confero" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gcofe outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gcofe.exe" "" "" "Confero" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gcofe UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gcofe.exe" "" "" "Confero" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "CONFERO_SOCKET" "R" "HKLM" "\\.\pipe\gcofe.ipc"
  ${EnvVarUpdate} $0 "CONFERO_SOCKET" "A" "HKLM" "\\.\pipe\gcofe.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GCOFE_IDX}
    SectionGetSize ${GCOFE_IDX} $0
