...
// Package graphql provides a GraphQL interface to Confero node data.
package graphql
...
// Account represents an Confero account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Confero transaction.
...
// Block represents an Confero block.
...
type CallData struct {
	From                 *common.Address // The Confero address the call is from.
	To                   *common.Address // The Confero address the call is to.
