...
// ConferoAPI provides an API to access Confero full node-related information.
type ConferoAPI struct {
	e *Confero
}

// NewConferoAPI creates a new Confero protocol API for full nodes.
func NewConferoAPI(e *Confero) *ConferoAPI {
	return &ConferoAPI{e}
}

// Etherbase is the address that mining rewards will be send to.
func (api *ConferoAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase).
func (api *ConferoAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate.
func (api *ConferoAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *ConferoAPI) Mining() bool {
...
func NewMinerAPI(e *Confero) *MinerAPI {
	return &MinerAPI{e}
}
...
// AdminAPI is the collection of Confero full node related APIs for node
// administration.
...
func NewAdminAPI(eth *Confero) *AdminAPI {
...
// DebugAPI is the collection of Confero full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *Confero) *DebugAPI {
