...
import (
	...
	"github.com/confero-network/go-confero/p2p/msgrate"
...
// Syncer is an Confero account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Confero state over the
// snap protocol.
