...
// Syncing provides information when this nodes starts synchronising with the Confero network and when it's finished.
...
type SyncingResult struct {
	...
	Status  confero.SyncProgress `json:"status"`
}
