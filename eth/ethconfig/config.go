...
// Defaults contains default settings for use on the Confero main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Confero main net block is used.
	...
	// canonical chain of all remote peers. Setting the option makes gcofe verify the
	...
	// send-transaction variants. The unit is cofe.
	RPCTxFeeCap float64
