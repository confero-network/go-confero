// Copyright 2021 The go-confero Authors
...
import (
	...
	"github.com/confero-network/go-confero/core/state/snapshot"
	...
	"github.com/confero-network/go-confero/trie"
...
var (
	snapshotCommand = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale confero state data based on the snapshot",
				ArgsUsage: "<root>",
				Action:    pruneState,
				...
				Description: `
gcofe snapshot prune-state <state-root>
...
during the use of Gcofe, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
gcofe snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gcofe snapshot check-dangling-storage <state-root> traverses the snap storage 
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gcofe snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gcofe snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gcofe snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gcofe dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gcofe dump', but uses the snapshots
