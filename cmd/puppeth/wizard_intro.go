...
// setting up a new or managing an existing Confero private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Confero private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Confero network down to  |")
	...
	log.Info("Administering Confero network", "name", w.network)
