...
type wizard struct {
	...
	services map[string][]string   // Confero services known to be running on servers
...
// converts it to an Confero address. If an empty line is entered, the default
// value is returned.
