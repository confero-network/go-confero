...
// Package ethapi implements the general Confero API functions.
package ethapi
...
type Backend interface {
	// General Confero API
	SyncProgress() confero.SyncProgress
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewConferoAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewConferoAccountAPI(apiBackend.AccountManager()),
		}, {
			Namespace: "personal",
