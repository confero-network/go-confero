...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gcofe.ipc", false, filepath.Join(os.TempDir(), "gcofe.ipc")},
		{"data", "gcofe.ipc", false, "data/gcofe.ipc"},
		{"data", "./gcofe.ipc", false, "./gcofe.ipc"},
		{"data", "/gcofe.ipc", false, "/gcofe.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gcofe.ipc", true, `\\.\pipe\gcofe.ipc`},
		{"data", "gcofe.ipc", true, `\\.\pipe\gcofe.ipc`},
		{"data", `\\.\pipe\gcofe.ipc`, true, `\\.\pipe\gcofe.ipc`},
	}
