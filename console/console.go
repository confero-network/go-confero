...
import (
	...
	"github.com/confero-network/go-confero/internal/jsre"
	"github.com/confero-network/go-confero/internal/jsre/deps"
	"github.com/confero-network/go-confero/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Confero requests through
...
// Welcome show summary of current Gcofe instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gcofe JavaScript console!\n\n"

	// Print some generic Gcofe metadata
