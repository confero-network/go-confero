...
// Header represents a block header in the Confero blockchain.
type Header struct {
...
// Block represents an entire block in the Confero blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Confero RLP block format.
