...
// It can be used for testing that restart Gcofe normally.
...
// It can be used for testing that restart Gcofe after the crash.
...
// Tests a Gcofe restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gcofe was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gcofe was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gcofe was running with snapshot enabled. Then restarts without
...
// Tests the Gcofe was running with snapshot enabled and resetHead is applied.
...
// Tests the Gcofe was running with a complete snapshot and then imports a few
