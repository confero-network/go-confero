...
//
// https://github.com/confero-network/go-confero/pull/15941
...
//
// Details at:
//  - https://github.com/confero-network/go-confero/issues/18977
//  - https://github.com/confero-network/go-confero/pull/18988
...
//   with 0.001 cofe (thus created but no code)
...
func TestEIP1559Transition(t *testing.T) {
	var (
		...
		addr1   = crypto.PubkeyToAddress(key1.PublicKey)
		addr2   = crypto.PubkeyToAddress(key2.PublicKey)
		funds   = new(big.Int).Mul(common.Big1, big.NewInt(params.Cofe))
		gspec   = &Genesis{
