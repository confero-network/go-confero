...
pruning. Remember don't start the Gcofe without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gcofe snapshot prune-state --help" for more details.
`
