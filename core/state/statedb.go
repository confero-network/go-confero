...
// StateDB structs within the confero protocol are used to store anything
...
//
// Carrying over the balance ensures that Cofe doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/confero-network/go-confero/pull/16485#issuecomment-380438527),
