...
// NewID calculates the Confero fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Confero fork ID from an existing chain instance.
