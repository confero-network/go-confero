...
// Package ethclient provides a client for the Confero RPC API.
package ethclient
...
// Client defines typed wrappers for the Confero RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, confero.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*confero.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (confero.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q confero.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q confero.FilterQuery, ch chan<- types.Log) (confero.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q confero.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg confero.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg confero.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg confero.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*confero.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg confero.CallMsg) (uint64, error) {
...
func toCallArg(msg confero.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *confero.SyncProgress {
	if p == nil {
		return nil
	}
	return &confero.SyncProgress{
