...
// See https://github.com/confero-network/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Confero presale wallet and stores
