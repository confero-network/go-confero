...
// Package bind generates Confero contract Go bindings.
//
// Detailed usage document and tutorial available on the go-confero Wiki page:
// https://github.com/confero-network/go-confero/wiki/Native-DApps:-Go-bindings-to-Confero-contracts
package bind
